...
description: Core UI/UX engineering skill for building highly interactive, spatial, weightless, and glassmorphism-based web interfaces using GSAP, 3D CSS transforms, and buttery smooth micro-interactions.
risk: safe
source: community
